      ...
      <div className="container mx-auto py-6 flex-grow">
        ...
        <div className="flex flex-col">
          {friends.map(friend => (
            ...
            >
              <div className="flex items-center justify-between"> {/* Changed to flex and added justify-between */}
                {/* Profile Picture */}
                ...
                <div className="flex flex-col mt-2"> {/* Adjusted to flex-col */}
              ...
              <div className="absolute right-4 bottom-4"> {/* Adjust positioning */}
                <button onClick={() => removeFriend(friend.id)} className="border-2 border-red-500 bg-red-500 text-white px-4 py-2 rounded-md mr-2">Remove Friend</button>
              </div>
            </div>
          ))}
        </div>
